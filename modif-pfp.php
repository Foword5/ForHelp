        ...
        <div class="page"><main>
            <?php
                if (isset($_GET['error'])){
                    ...
                    }else if ($_GET["error"] == "noimg") {
                        echo "<p style='color:red;'>Veuillez choisir une image</p>";
                    }
                }
            ?>
            <table>
                <form action='actions/modif-pfp-action.php' enctype="multipart/form-data" method="post">
                    <tr>
                        <td>
